...
class Role {
  ...
  Role({
    ...
    this.hidden,
    this.description,
    this.clusterPermissions = const [],
    this.indexPermissions = const [],
    this.tenantPermissions = const [],
    this.static_,
  });
  ...
  bool operator ==(Object other) =>
      ...
      other is Role &&
          ...
          other.clusterPermissions == clusterPermissions &&
          other.indexPermissions == indexPermissions &&
          other.tenantPermissions == tenantPermissions &&
  ...
  int get hashCode =>
      ...
      (clusterPermissions.hashCode) +
      (indexPermissions.hashCode) +
      (tenantPermissions.hashCode) +
      (static_ == null ? 0 : static_!.hashCode);

  @override
  String toString() =>
      'Role[reserved=$reserved, hidden=$hidden, description=$description, clusterPermissions=$clusterPermissions, indexPermissions=$indexPermissions, tenantPermissions=$tenantPermissions, static_=$static_]';
  ...
  Map<String, dynamic> toJson() {
    ...
    json[r'cluster_permissions'] = this.clusterPermissions;
    json[r'index_permissions'] = this.indexPermissions;
    json[r'tenant_permissions'] = this.tenantPermissions;
  ...
  static Role? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Role(
        ...
        clusterPermissions: json[r'cluster_permissions'] is List
            ? (json[r'cluster_permissions'] as List).cast<String>()
            : const [],
        indexPermissions:
            IndexPermission.listFromJson(json[r'index_permissions']),
        tenantPermissions:
            TenantPermission.listFromJson(json[r'tenant_permissions']),
